...
//        args=new String[]{"/Users/november/Desktop/virtualData.txt","/Users/november/Desktop/file/test/out9"};
...
//            String newMoney;
//            for(Currency currency:currencyList) {
//                args = new String[]{HadoopConfig.HADOOP_INPUT_FILE+currency.getCurrencyname()+".txt", HadoopConfig.HADOOP_OUTPUT_FILE};
//                //查询最新的价格
//                newMoney = okExService.getNewMoney(currency.getCurrencyname());
//                HadoopConfig.NOW_MONEY=Double.parseDouble(newMoney);
//                //删除文件，保证hadoop正常运行
